...
/**
 * 类功能说明：根据checktoken 的结果转化用户信息<br/>
 * 类修改者：<br/>
 * 修改日期：<br/>
 * 修改说明：<br/>
 * 公司名称：广东以大供应链管理有限公司 <br/>
 * 作者：luorx <br/>
 * 创建时间：2020年1月7日 上午10:18:05 <br/>
 * 版本：V1.0 <br/>
 */
public class SomUserAuthenticationConverter implements UserAuthenticationConverter {
	...
	public Authentication extractAuthentication(Map<String, ?> map) {
		if (map.containsKey(USERNAME)) {
			...
			SomUser user = new SomUser(id, deptId, username, N_A, true
